...
* The following code recreates Table [6] in the paper and includes additional robustness checks.
...
eststo col1: xtreg ln_agout L4.cum_class_lr L4.ln_i_lstock ln_i_fert L4.ln_i_tract i.year, fe vce(cluster id)

*** Column (2) - Including controls $e_{i,t}$ ***
eststo col2: xtreg ln_agout L4.cum_class_lr L4.ln_i_lstock ln_i_fert L4.ln_i_tract i_perarr i.year, fe vce(cluster id)

*** Column (3) - Including additional controls from Barro (2003), namely $f_{i,t}$ ***
eststo col3: xtreg ln_agout L4.cum_class_lr L4.ln_i_lstock ln_i_fert L4.ln_i_tract ///
...
eststo col4: xtreg ln_agout L4.cum_class_lr L4.ln_i_lstock ln_i_fert L4.ln_i_tract ///
    i_perarr ln_tfr inv_life_expectancy L4.rule_of_law ///
...
eststo col5: xtgls ln_agout L4.cum_class_lr L4.ln_i_lstock ln_i_fert L4.ln_i_tract i.year, panels(hetero) corr(ar1)

*** Column (6) - Including controls $e_{i,t}$ ***
eststo col6: xtgls ln_agout L4.cum_class_lr L4.ln_i_lstock ln_i_fert L4.ln_i_tract i_perarr plqi i.year, panels(hetero) corr(ar1)

*** Column (7) - Including additional controls from Barro (2003), namely $f_{i,t}$ ***
eststo col7: xtgls ln_agout L4.cum_class_lr L4.ln_i_lstock ln_i_fert L4.ln_i_tract ///
...
eststo col8: xtgls ln_agout L4.cum_class_lr L4.ln_i_lstock ln_i_fert L4.ln_i_tract ///
    i_perarr plqi ln_tfr inv_life_expectancy L4.rule_of_law ///
    L4.gov_consumption L4.i_rdensity i.year, panels(hetero) corr(ar1)

* Export to LaTeX *
esttab col1 col2 col3 col4 col5 col6 col7 col8 ///
    using "rtable3.tex", replace tex ///
