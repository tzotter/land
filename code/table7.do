...
* The following code recreates Table [7] in the paper and includes additional robustness checks.
...
eststo col2: xtreg ln_agout L4.mot_cons L4.mot_ten L4.mot_priv L4.ln_i_lstock ln_i_fert L4.ln_i_tract i.year, fe vce(cluster id)
...
eststo col4: xtreg ln_agout L4.mot_cons L4.mot_ten L4.mot_priv L4.ln_i_lstock ln_i_fert L4.ln_i_tract ///
    i_perarr ln_tfr inv_life_expectancy L4.rule_of_law ///
    L4.gov_consumption L4.i_rdensity i.year, fe vce(cluster id)
...
eststo col6: xtgls ln_agout L4.mot_cons L4.mot_ten L4.mot_priv L4.ln_i_lstock ln_i_fert L4.ln_i_tract i.year, panels(hetero) corr(ar1)
...
eststo col8: xtgls ln_agout L4.mot_cons L4.mot_ten L4.mot_priv L4.ln_i_lstock ln_i_fert L4.ln_i_tract ///
    i_perarr plqi ln_tfr inv_life_expectancy L4.rule_of_law ///
    L4.gov_consumption L4.i_rdensity i.year, panels(hetero) corr(ar1)

* Export to LaTeX *
esttab col1 col2 col3 col4 col5 col6 col7 col8 ///
    using "rtable4.tex", replace tex ///
