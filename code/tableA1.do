...
* The following code recreates Table [A1] in the paper and includes additional robustness checks.
...
eststo col1: xtreg ln_cereal_yield L4.cum_lr L4.ln_i_lstock ln_i_fert L4.ln_i_tract i.year, fe vce(cluster id)

*** Column (2) - Fixed-Effects (FE) OLS with an indicator variable for time and controls $d_{i,t}$ ***
eststo col2: xtreg ln_cereal_yield L4.mot_cons L4.mot_ten L4.mot_priv L4.ln_i_lstock ln_i_fert L4.ln_i_tract i.year, fe vce(cluster id)

*** Column (3) - Column (1) including additional controls, namely $e_{i,t} + f_{i,t}$ ***
eststo col3: xtreg ln_cereal_yield L4.cum_lr L4.ln_i_lstock ln_i_fert L4.ln_i_tract ///
...
eststo col4: xtreg ln_cereal_yield L4.mot_cons L4.mot_ten L4.mot_priv L4.ln_i_lstock ln_i_fert L4.ln_i_tract ///
    i_perarr ln_tfr inv_life_expectancy L4.rule_of_law ///
    L4.gov_consumption L4.i_rdensity i.year, fe vce(cluster id)

*** Column (5) - GLS with AR(1), heteroscedasticity in the error structure and an indicator variable for time ***
eststo col5: xtgls ln_cereal_yield L4.cum_lr L4.ln_i_lstock ln_i_fert L4.ln_i_tract i.year, panels(hetero) corr(ar1)

*** Column (6) - Including controls $e_{i,t}$ ***
eststo col6: xtgls ln_cereal_yield L4.mot_cons L4.mot_ten L4.mot_priv L4.ln_i_lstock ln_i_fert L4.ln_i_tract i.year, panels(hetero) corr(ar1)

*** Column (7) - Column (5) including additional controls, namely $e_{i,t} + f_{i,t}$ ***
eststo col7: xtgls ln_cereal_yield L4.cum_lr L4.ln_i_lstock ln_i_fert L4.ln_i_tract ///
...
eststo col8: xtgls ln_cereal_yield L4.mot_cons L4.mot_ten L4.mot_priv L4.ln_i_lstock ln_i_fert L4.ln_i_tract ///
    i_perarr plqi ln_tfr inv_life_expectancy L4.rule_of_law ///
    L4.gov_consumption L4.i_rdensity i.year, panels(hetero) corr(ar1)

* Export to LaTeX *
esttab col1 col2 col3 col4 col5 col6 col7 col8 ///
    using "rtable6.tex", replace tex ///
