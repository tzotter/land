...
* The following code recreates Table [16] in the paper and includes additional robustness checks.
...
eststo col1: reg land_gini mot_ceil ln_i_lstock ln_i_fert ln_i_tract i_perarr, robust

*** Column (2) - Column (1) including additional controls $g_{i,t}$ ***
eststo col2: reg land_gini mot_ceil ln_i_lstock ln_i_fert ln_i_tract i_perarr ln_gdp_pc rule_of_law eduatt population_gr, robust

** Dependent variable: agpop **
*** Column (3) - OLS Regression with controls $d_{i,t}$ ***
eststo col3: reg agpop mot_ceil ln_i_lstock ln_i_fert ln_i_tract i_perarr, robust

*** Column (4) - Column (3) including additional controls $g_{i,t}$ ***
eststo col4: reg agpop mot_ceil ln_i_lstock ln_i_fert ln_i_tract i_perarr ln_gdp_pc rule_of_law eduatt population_gr, robust

* Export to LaTeX *
esttab col1 col2 col3 col4 ///
    using "rtable12.tex", replace tex ///
