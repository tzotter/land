...
* The following code recreates Table [A3] in the paper and includes additional robustness checks.
...
eststo col2: reg land_gini mot_cons mot_ten ln_i_lstock ln_i_fert ln_i_tract i_perarr, robust
...
eststo col4: reg land_gini mot_cons mot_ten ln_i_lstock ln_i_fert ln_i_tract i_perarr ln_gdp_pc rule_of_law eduatt population_gr, robust
...
eststo col6: reg agpop mot_cons mot_ten ln_i_lstock ln_i_fert ln_i_tract i_perarr, robust
...
eststo col8: reg agpop mot_cons mot_ten ln_i_lstock ln_i_fert ln_i_tract i_perarr ln_gdp_pc rule_of_law eduatt population_gr, robust

* Export to LaTeX *
esttab col1 col2 col3 col4 col5 col6 col7 col8 ///
    using "rtable13.tex", replace tex ///
